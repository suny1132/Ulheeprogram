...
public class hFilter {
    ...
    public static double P_h_dot_11 = 0, P_h_next_11 = 0;
    public static double P_h_dot_12 = 0, P_h_next_12 = 0;
    public static double P_h_dot_13 = 0, P_h_next_13 = 0;
    public static double P_h_dot_21 = 0, P_h_next_21 = 0;
    public static double P_h_dot_22 = 0, P_h_next_22 = 0;
    public static double P_h_dot_23 = 0, P_h_next_23 = 0;
    public static double P_h_dot_31 = 0, P_h_next_31 = 0;
    public static double P_h_dot_32 = 0, P_h_next_32 = 0;
    public static double P_h_dot_33 = 0, P_h_next_33 = 0;

    public static double P_h_update_11 = 0;
    public static double P_h_update_12 = 0;
    public static double P_h_update_13 = 0;
    public static double P_h_update_21 = 0;
    public static double P_h_update_22 = 0;
    public static double P_h_update_23 = 0;
    public static double P_h_update_31 = 0;
    public static double P_h_update_32 = 0;
    public static double P_h_update_33 = 0;

    public static double x_h_tu_11 = 0, x_h_mu_11 = 0;
    public static double x_h_tu_21 = 0, x_h_mu_21 = 0;
    public static double x_h_tu_31 = 0, x_h_mu_31 = 0;
    ...
    public static double[] timeUpdate(double[] x_h, double gy, double dt) {
        // Time Update
        F_h_12 = -gy;
    ...
    public static double[] measUpdate(double[] x_h, double GPS_heading) {
        x_h_tu_11 = x_h[0];
        x_h_tu_21 = x_h[1];
        x_h_tu_31 = x_h[3];
